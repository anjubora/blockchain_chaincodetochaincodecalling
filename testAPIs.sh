...
function setChaincodePath(){
	...
	case "$LANGUAGE" in
		"golang")
		CC_SRC_PATH1="github.com/example_cc1/go"
    CC_SRC_PATH2="github.com/example_cc2/go"
		;;
		"node")
...
echo "POST Install chaincode1 on Org2"
echo
curl -s -X POST \
  http://localhost:4000/chaincodes \
  -H "authorization: Bearer $ORG2_TOKEN" \
...
echo "POST instantiate chaincode2 on Org1"
echo
curl -s -X POST \
